...
synth_design -top audio_read_playback_top -part xc7s50csga324-1
...
write_checkpoint -force -noxdef audio_read_playback_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file audio_read_playback_top_utilization_synth.rpt -pb audio_read_playback_top_utilization_synth.pb"
